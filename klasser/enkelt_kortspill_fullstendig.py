...
# Vinneren er den spilleren med høyest poeng på kortene.
...
def finn_vinnere(spillere):                       # Funksjon for å finne vinnere
    vinnere = list()                                  # vinner må være liste
    for spiller in spillere:                      # går gjennom spillere en for en
        if len(vinnere) == 0:
            vinnere.append(spiller)
            continue
        if spiller.kort.verdi > vinnere[0].kort.verdi:
            vinnere.clear()                  # bruker clear for å slette inholdet i lista
            vinnere.append(spiller)
...
if __name__ == "__main__":
    ...
    vinnere = finn_vinnere(spillere)                        # funksjonskall finn_vinnere
    while len(vinnere) > 1:
        print(len(vinnere))
        spillere = vinnere
        for spiller in spillere:
